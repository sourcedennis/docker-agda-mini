...
RUN apt-get update &&\
    apt-get install -y --no-install-recommends zlib1g-dev build-essential wget curl libffi-dev libffi8 libgmp-dev libgmp10 libncurses-dev libncurses5 libtinfo5 ca-certificates locales pkg-config &&\
